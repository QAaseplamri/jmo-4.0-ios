...
Mobile.tap(findTestObject('JMO/Registrasi dan Aktivasi/Registrasi Akun/XCUIElementTypeStaticText - Buat Akun Baru'), 0)

Mobile.delay(2)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('JMO/Registrasi dan Aktivasi/Registrasi Akun/XCUIElementTypeStaticText - Ya, Saya Sudah Daftar'), 
    0)
...
Mobile.tap(findTestObject('JMO/Registrasi dan Aktivasi/Registrasi Akun/XCUIElementTypeStaticText - Pekerja Migran Indonesia'), 
    0)
...
Mobile.tap(findTestObject('JMO/Registrasi dan Aktivasi/Registrasi Akun/XCUIElementTypeButton - icRadioButtonInactive - Paspor'), 
    0)

Mobile.tap(findTestObject('JMO/Registrasi dan Aktivasi/Registrasi Akun/XCUIElementTypeTextField - No Paspor'), 0)

Mobile.setText(findTestObject('JMO/Registrasi dan Aktivasi/Registrasi Akun/XCUIElementTypeTextField - No Paspor'), 'C5695046', 
    0)
...
Mobile.setText(findTestObject('Object Repository/JMO/Registrasi dan Aktivasi/XCUIElementTypeTextField - Email'), 'testing15@gmail.com', 
    0)
...
String emailotpkey = 'JMO#otp#testing15@gmail.com'
...
//// Key yang digunakan untuk mendapatkan OTP
//String smsotpkey = 'JMO#otp#62858111444777'
//
//// Mendapatkan OTP dari beberapa Redis server
...
Mobile.verifyElementText(findTestObject('JMO/Registrasi dan Aktivasi/Registrasi Akun/XCUIElementTypeStaticText - Pendaftaran kepesertaan Anda di BPJAMSOSTEK berhasil. Anda dapat mengakses semua fitur di aplikasi ini'), 
    'Pendaftaran kepesertaan Anda di BPJAMSOSTEK berhasil. Anda dapat mengakses semua fitur di aplikasi ini')
