...
// Key yang digunakan untuk mendapatkan OTP
String smsotpkey = 'JMO#otp#62858123456777'
...
Mobile.verifyElementText(findTestObject('JMO/Registrasi dan Aktivasi/XCUIElementTypeStaticText - Pendaftaran kepesertaan Anda di BPJAMSOSTEK berhasil. Anda dapat mengakses semua fitur di aplikasi ini'), 
